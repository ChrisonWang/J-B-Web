...

{
    ...
    public function create(Request $request)
    {
        ...
        $pageContent = view('judicial.manage.server.introAdd',$this->page_data)->render();
    ...
    public function store(Request $request)
    {
        ...
        //添加成功后刷新页面数据
            ...
            if(count($introduce)==0){
                ...
                $pageContent = view('judicial.manage.server.introList',$this->page_data)->render();
                json_response(['status'=>'succ','type'=>'page', 'res'=>$pageContent]);
            }
            //返回到前段界面
    ...
    public function show(Request $request)
    {
        ...
        $pageContent = view('judicial.manage.server.introDetail',$this->page_data)->render();
        json_response(['status'=>'succ','type'=>'page', 'res'=>$pageContent]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        //页面中显示
        $this->page_data['intro'] = $intro;
        $pageContent = view('judicial.manage.server.introEdit',$this->page_data)->render();
        json_response(['status'=>'succ','type'=>'page', 'res'=>$pageContent]);
    }
