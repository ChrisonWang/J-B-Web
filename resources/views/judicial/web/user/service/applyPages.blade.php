@if(isset($list) && count($list)>0)
    ...
    <div class="zwr_ft" hidden>
        <div class="fy_left">
                ...
                <span>
                    <a href="javascript: void(0) ;" data-type="apply" data-method="per" data-now="{{ $pages['now_page'] }}" data-c="s_apply" onclick="service_page($(this))">上一页</a>
                </span>
                <span>
                    <a href="javascript: void(0) ;" data-type="apply" data-method="next" data-now="{{ $pages['now_page'] }}" data-c="s_apply" onclick="service_page($(this))">下一页</a>
                </span>
                <span>
                    <a href="javascript: void(0) ;" data-type="apply" data-method="last" data-now="{{ $pages['now_page'] }}" data-c="s_apply" onclick="service_page($(this))"> 尾页</a>
                </span>
            <div class="fy_right">
