    ...
    <div class="zw_right w810">
        ...
        @if(isset($pages) && is_array($pages))
            <div class="zwr_ft">
                ...
                <span>
                    @if($pages['now_page']<$pages['count_page'] ) <a href="{{ '/service/forms/'.$channel_id.'/'.($pages['now_page']+1) }}">下一页</a> @else 下一页 @endif
                </span>
                    <span>@if($pages['count_page']>1 && $pages['now_page']<$pages['count_page'] )<a href="{{ '/service/forms/'.$channel_id.'/'.$pages['count_page'] }}"> 尾页</a> @else 尾页 @endif</span>
                </div>
                <div class="fy_right">
                    ...
                    <a class="fy_btn" onclick="cms_page_jumps($(this))" data-type="{{ '/service/forms/'.$channel_id }}">跳转</a>
                </div>
            </div>
        @endif
