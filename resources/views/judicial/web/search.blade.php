...
<div class="zw_right serach" style="min-height: 400px">
    <div class="serach_body">
        <form action="{{ URL::route('search') }}" method="post">
            ...
            <input type="search" name="keywords" placeholder="输入搜索关键词" value="@if(isset($keywords) && !empty($keywords)) {{ $keywords }} @endif" style=" padding-right:10px; height: 40px; background: #FFFFFF; border: 1px solid #ECECEC;">
