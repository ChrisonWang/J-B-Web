    ...
    <div class="panel-body">
        <form class="form-horizontal" id="userEditForm">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input disabled type="text" class="form-control" value="{{ $user_detail['email'] }}" id="email" name="email" placeholder="请输邮箱" />
                </div>
            </div>
            <div class="form-group">
                <label for="nickname" class="col-md-1 control-label">显示名：</label>
                <div class="col-md-3">
                    <input disabled type="text" class="form-control" value="{{ $user_detail['nickname'] }}" id="nickname" name="nickname" placeholder="请输显示名" />
                </div>
            </div>
            <div class="form-group">
                <label for="password" class="col-md-1 control-label">密码：</label>
                <div class="col-md-3">
                    <input disabled type="text" class="form-control" id="password" name="password" placeholder="请输入密码,留空则不修改" autocomplete="off" onfocus="this.type='password'"/>
                </div>
            </div>
            <div class="form-group">
                <label for="disabled" class="col-md-1 control-label">是否启用：</label>
                <div class="col-md-3">
                    <input disabled type="checkbox" id="disabled" name="disabled" class="form-control" value="no" @if($user_detail['disabled'] == 'no') checked @endif>
                </div>
            </div>
            <div class="form-group">
