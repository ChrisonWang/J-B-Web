    ...
    <div class="panel-body">
        ...
        <div class="container-fluid" id="this-container">
            <table class="table table-bordered table-hover table-condensed">
                ...
                <tr>
                    <td>
                        <a href="javascript: void(0) ;" data-key="{{ $article['key'] }}" data-method="show"  data-archived_key="{{ isset($archived_key)?$archived_key:'' }}" data-archived="{{ (isset($is_archived)&&$is_archived=='yes') ? 'yes' : 'no' }}" onclick="articleMethod($(this))">查看</a>
                        @if(!isset($is_archived))
                            &nbsp;&nbsp;
