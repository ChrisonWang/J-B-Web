    ...
    <div class="panel-body">
        <form class="form-horizontal" id="formsEditForm">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input disabled type="checkbox" class="" id="disabled" value="no" name="disabled" @if($form_detail['disabled'] == 'no') checked @endif/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <textarea disabled name="description" id="description">{{ $form_detail['description'] }}</textarea>
                </div>
            </div>
            <div class="form-group">
