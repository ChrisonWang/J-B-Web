<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" id="editAidTypeForm">
            <input name="key" value="{{ $type_detail['key'] }}" type="hidden">
            <div class="form-group">
                <label for="type_name" class="col-md-2 control-label"><red>*</red> 名称：</label>
                <div class="col-md-3">
                    <input type="text" class="form-control" value="{{ $type_detail['type_name'] }}"  id="type_name" name="type_name" placeholder="请输入名称" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-offset-1 col-md-2">
                    <button type="button" class="btn btn-info btn-block" onclick="editAidType()">确认</button>
                </div>
