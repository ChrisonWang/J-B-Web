<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" id="editLawyerForm">
            ...
            <div class="form-group">
                <label for="thumb" class="col-md-1 control-label">照片：</label>
                <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" class="form-control" id="is_partner" name="is_partner" value="yes" @if($lawyer_detail['is_partner'] == 'yes') checked @endif/>
            </div>
            <div class="form-group">
